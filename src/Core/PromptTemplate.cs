...
namespace PromptSpec.Core
{
    ...
    public class PromptTemplate
    {
        ...
        /// </summary>
    public string Version { get { return _specification.Version; } }

        /// <summary>
        /// Gets the description of the prompt template.
        /// </summary>
    public string Description { get { return _specification.Description; } }

        /// <summary>
        /// Gets the system message for the prompt template.
        /// </summary>
    public string SystemMessage { get { return _specification.SystemMessage; } }

        /// <summary>
        /// Gets the output format for the prompt template.
        /// </summary>
    public string OutputFormat { get { return _specification.OutputFormat; } }
        ...
        private void ValidatePlaceholders(Dictionary<string, object> replacements)
        {
            ...
            foreach (KeyValuePair<string, PlaceholderDefinition> kvp in _specification.Placeholders)
            {
                ...
                object value;
                if (replacements.TryGetValue(placeholderName, out value) && value != null)
                {
